from Includes import RoboDKProgram 
...
names_paths = [["TopDispenser", current_directory + '/StepFiles/CoverDispenserAssembled.step'],
               ["FuseTower", current_directory + '/StepFiles/FuseTower.step'],
               ["PCBDispenser", current_directory + '/StepFiles/PCBDispenser.step'],
               ["BottomDispenser", current_directory + '/StepFiles/CoverDispenserAssembled.step']]
...
gripper_radius = 129 #mm

radius = 450 #mm
d_fuse_angle = (((robomath.pi/2)*gripper_radius)/radius) * 180/robomath.pi
